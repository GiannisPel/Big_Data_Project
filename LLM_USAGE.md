...
| Q3 | ChatGPT | Βοήθεια στον σχεδιασμό των τριών rankings και debugging | έτρεξα τις υλοποιήσεις στο Spark/Kubernetes, έλεγξα τα HDFS outputs, συνέκρινα τα result tables και τους χρόνους, επιβεβαίωσα τα physical plans, δημιούργησα τα plots τοπικά |
| Q4 | - | - | - |
| Q5 | - | - | - |
| Q6 | - | - | - |
